document.addEventListener('DOMContentLoaded', function() {
    ...
    const letterSpacings = ['12px', '8px', '15px', '5px', '10px', '20px', '4px', '16px', '6px', '18px', '3px', '7px', '9px', '11px', '13px', '14px', '17px', '19px', '21px', '2px', '1px', '22px', '25px', '30px', '0px', '35px', '40px', '24px', '27px', '32px'];
    const currentLogo = document.querySelector('.loader-logo.current');
    const nextLogo = document.querySelector('.loader-logo.next');
    let fontIndex = 0;
        ...
        gsap.timeline()
            ...
            .to(loader, {
                ...
                onComplete: () => {
                    ...
                    // 确保火箭模型内容正确显示
                    const initialModelContent = document.querySelector('.model-content.active');
                    if (initialModelContent) {
                        gsap.set(initialModelContent, { opacity: 1, y: 0 });
                        
                        const modelImage = initialModelContent.querySelector('.model-image');
                        const modelDetails = initialModelContent.querySelector('.model-details');
                        
                        if (modelImage) {
                            gsap.set(modelImage, { opacity: 1, x: 0 });
    ...
    controlButtons.forEach(button => {
        button.addEventListener('click', () => {
            ...
            // 发送消息给three-effects.js
            /*
            const event = new CustomEvent('rocket-control', { 
